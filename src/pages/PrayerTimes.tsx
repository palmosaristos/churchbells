        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <Accordion type="multiple" defaultValue={["prayer-times", "bell-sound"]} className="space-y-4">
              ...
              <AccordionContent className="bg-white dark:bg-background border-2 border-t-0 border-[#d4a574] dark:border-amber-700 rounded-b-lg p-5 animate-accordion-down">
                <div className="space-y-6">
                  <div className="grid gap-8 md:grid-cols-2">
                    <div className={`space-y-4 group p-5 rounded-lg bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900/40 dark:to-orange-900/40 ${morningPrayerEnabled ? 'border-4 border-amber-500' : 'border-2 border-[#d4a574] dark:border-amber-700'}`}>
            ...
            <AccordionItem value="bell-sound" className="border-none">
              ...
              <AccordionContent className="bg-white dark:bg-background border-2 border-t-0 border-[#d4a574] dark:border-amber-700 rounded-b-lg p-5 animate-accordion-down">
                <div className="space-y-6">
                  <p className="text-3xl font-cormorant text-foreground mb-2 text-center italic">
                  ...
                  <div className="space-y-4">
                    ...
                    <RadioGroup value={morningPrayerEnabled ? morningCallType : ""} onValueChange={setMorningCallType} className="space-y-4" aria-label="Choisir la durée de l'appel pour la prière du matin">
                      <div className={`flex items-center justify-between space-x-3 p-4 rounded-lg bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900/40 dark:to-orange-900/40 hover:border-primary/50 transition-colors ${morningPrayerEnabled && morningCallType === 'short' ? 'border-4 border-amber-500' : 'border-2 border-[#d4a574] dark:border-amber-700'}`}>
                        ...
                        <Button variant="outline" size="sm" className="font-cinzel shadow-md hover:shadow-lg transition-all hover:scale-[1.02]" onClick={() => toggleAudio({ audioUrl: "/audio/short-call.mp3", traditionName: "Short Call", type: 'prayer', volume: morningBellVolume })} aria-label="Preview short bell call sound">
                      ...
                      <div className={`flex items-center justify-between space-x-3 p-4 rounded-lg bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900/40 dark:to-orange-900/40 hover:border-primary/50 transition-colors ${morningPrayerEnabled && morningCallType === 'long' ? 'border-4 border-amber-500' : 'border-2 border-[#d4a574] dark:border-amber-700'}`}>
                        ...
                        <Button variant="outline" size="sm" className="font-cinzel shadow-md hover:shadow-lg transition-all hover:scale-[1.02]" onClick={() => toggleAudio({ audioUrl: "/audio/long-call.mp3", traditionName: "Long Call", type: 'prayer', volume: morningBellVolume })} aria-label="Preview long bell call sound">
                          <Volume2 className="w-4 h-4 mr-2" />
                  ...
                  <div className="space-y-4">
                    ...
                    <RadioGroup value={eveningPrayerEnabled ? eveningCallType : ""} onValueChange={setEveningCallType} className="space-y-4" aria-label="Choisir la durée de l'appel pour la prière du soir">
                      <div className={`flex items-center justify-between space-x-3 p-4 rounded-lg bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900/40 dark:to-orange-900/40 hover:border-primary/50 transition-colors ${eveningPrayerEnabled && eveningCallType === 'short' ? 'border-4 border-amber-500' : 'border-2 border-[#d4a574] dark:border-amber-700'}`}>
                        ...
                        <Button variant="outline" size="sm" className="font-cinzel shadow-md hover:shadow-lg transition-all hover:scale-[1.02]" onClick={() => toggleAudio({ audioUrl: "/audio/short-call.mp3", traditionName: "Short Call", type: 'prayer', volume: eveningBellVolume })} aria-label="Preview short bell call sound">
                          <Volume2 className="w-4 h-4 mr-2" />
                          {isPlaying && currentAudioUrl === "/audio/short-call.mp3" ? "Stop" : "Listen"}
                        </Button>
                      </div>
                      ...
                      <div className={`flex items-center justify-between space-x-3 p-4 rounded-lg bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900/40 dark:to-orange-900/40 hover:border-primary/50 transition-colors ${eveningPrayerEnabled && eveningCallType === 'long' ? 'border-4 border-amber-500' : 'border-2 border-[#d4a574] dark:border-amber-700'}`}>
                        ...
                        <Button variant="outline" size="sm" className="font-cinzel shadow-md hover:shadow-lg transition-all hover:scale-[1.02]" onClick={() => toggleAudio({ audioUrl: "/audio/long-call.mp3", traditionName: "Long Call", type: 'prayer', volume: eveningBellVolume })} aria-label="Preview long bell call sound">
                          <Volume2 className="w-4 h-4 mr-2" />
                          {isPlaying && currentAudioUrl === "/audio/long-call.mp3" ? "Stop" : "Listen"}
                        </Button>
                      </div>
            ...
            <AccordionItem value="prayer-reminder" className="border-none">
              ...
              <AccordionContent className="bg-white dark:bg-background border-2 border-t-0 border-[#d4a574] dark:border-amber-700 rounded-b-lg p-5 animate-accordion-down">
                <div className="space-y-8">
                  ...
                  <div className={`space-y-4 p-5 rounded-lg bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900/40 dark:to-orange-900/40 ${morningPrayerEnabled ? 'border-4 border-amber-500' : 'border-2 border-[#d4a574] dark:border-amber-700'}`}>
                    <div className="flex items-center justify-between">
                      <h3 className="flex items-center gap-2 font-cormorant text-2xl font-semibold text-foreground">
                        <Sun className="w-5 h-5 text-amber" />
                        {morningPrayerName}
                  ...
                  <div className={`space-y-4 p-5 rounded-lg bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900/40 dark:to-orange-900/40 ${eveningPrayerEnabled ? 'border-4 border-amber-500' : 'border-2 border-[#d4a574] dark:border-amber-700'}`}>
                    <div className="flex items-center justify-between">
                      <h3 className="flex items-center gap-2 font-cormorant text-2xl font-semibold text-foreground">
                        <Moon className="w-5 h-5 text-primary" />
                        {eveningPrayerName}
