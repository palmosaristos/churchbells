  ...
  return (
    <div className="min-h-screen bg-gradient-subtle">
      ...
      <div className="container mx-auto px-4 py-12 space-y-10">
        ...
        {/* Share Banner */}
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-vespers border-burgundy/20 rounded-full shadow-2xl border-2 p-8 md:p-10 aspect-square flex items-center justify-center max-w-2xl mx-auto">
